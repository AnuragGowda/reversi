...
def random_policy(board):
    ...
    while not board.game_over:
        ...
        board.make_move_in_place(random.choice(moves))
    # print("simulation over", board.winner, "won", board.count_score())
    if board.winner == 1:
        return 1
    if board.winner == 2:
        return 0
...
class MCTS:
    ...
    def _simulate(self, node):
        ...
        return random_policy(node.board)
        # invert_reward = True
        # while True:
        #     if node.is_terminal():
        #         reward = node.reward()
...
class Node():
    ...
    def find_children(self):
        ...
        for move in self.board.valid_moves():
            ...
            children.append(Node(board, move))
        return children
...
class MCTSAgent:
    ...
    def best_move(self, board):
        ...
        return tree.choose(node).prev_move
